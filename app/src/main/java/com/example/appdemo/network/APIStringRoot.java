...
public class APIStringRoot {
    ...
    static final String UPDATE_GROUP_NAME = "/api/chat/update-group-name";
    static final String UPDATE_PROFILE = "/api/user/update-profile";
    static final String UPDATE_COVER_PHOTO = "/api/user/update-coverphoto";
}
